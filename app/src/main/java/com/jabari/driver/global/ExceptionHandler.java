    ...
    public void generateError(String err) {
        switch (err) {
            ...
            case "null_doc":
                ...
                break;
            case "id":
                Toasty.error(myContext.getBaseContext(), myContext.getString(R.string.exp_null_id), Toasty.LENGTH_LONG).show();
                break;
        }
    }
    ...
    public void generateSuccess(String success) {
        ...
        switch (success) {
            ...
            case "sheba":
                ...
                break;
            case "accept":
                Toasty.success(myContext.getBaseContext(), myContext.getString(R.string.success_accept), Toasty.LENGTH_LONG).show();
                break;
        }
    }
}
